...
> As with the rest of the project, contributions to 321Vegan are governed by our [Code of Conduct](https://github.com/llambrecht/321vegan-tool/blob/main/CODE_OF_CONDUCT.md).
...
> - Welcome newcomers and encourage new contributors from all walks of life. Visit the [321Vegan Community Code of Conduct](https://github.com/llambrecht/321vegan-tool/blob/main/CODE_OF_CONDUCT.md).
...
Before you start contributing code, you’ll want to get the project running locally on your machine. Here’s how to set up the `321Vegan tool` app:
...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/<your-username>/321vegan-tool.git
   cd 321vegan-tool
   ```
